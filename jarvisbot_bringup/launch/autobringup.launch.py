...
def generate_launch_description():
  pkg_share = launch_ros.substitutions.FindPackageShare(package='jarvisbot_description').find('jarvisbot_description')
  navigation_dir = os.path.join(get_package_share_directory('jarvisbot_navigation'), 'launch')
  rviz_launch_dir=os.path.join(get_package_share_directory('jarvisbot_description'), 'launch')
  gazebo_launch_dir=os.path.join(get_package_share_directory('jarvisbot_gazebo'), 'launch')
  ...
  cartographer_launch_dir=os.path.join(get_package_share_directory('jarvisbot_slam'), 'launch')
  prefix_address = get_package_share_directory('jarvisbot_navigation') 
  default_model_path = os.path.join(pkg_share, 'models/urdf/jarvisbot.xacro')
  ...
  map_directory = os.path.join(get_package_share_directory(
        'jarvisbot_bringup'), 'maps','room2.yaml')
